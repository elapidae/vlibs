...
//=======================================================================================
Z_Image_Ref::Z_Image_Ref( const ZCM_Image *i )
    : img( *i )
{
    assert(i);
}
//=======================================================================================
bool Z_Image_Ref::is_valid() const
{
    return true;
}
//=======================================================================================
VImage::Format Z_Image_Ref::format() const
{
    return Z_Image::string_to_format( img.format );
}
//=======================================================================================
int Z_Image_Ref::width() const
{
    return img.width;
}
//=======================================================================================
int Z_Image_Ref::height() const
{
    return img.height;
}
//=======================================================================================
int Z_Image_Ref::bytes_per_line() const
{
    return img.bytes_per_line;
}
//=======================================================================================
const VImage::data_t *Z_Image_Ref::data() const
{
    return img.data.data();
}
//=======================================================================================
void Z_Image_Ref::detach()
{}
//=======================================================================================
const ZCM_Image &Z_Image_Ref::zcm_image() const
{
    return img;
}
//=======================================================================================
