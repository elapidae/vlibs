...
int VCVImage_Impl::format_to_VCVImageDepth(VImage::Format f)
{
    ...
    case Format::Gray8:   return CV_8UC1;
    case Format::RGB888:  return CV_8UC3;
    case Format::BGR888:  return CV_8UC3;
    }
...
VCVImage_Impl VCVImage_Impl::convert_to_format( const Format format_ )
{
    ...
    case Format::Gray8:
		switch( format_ )
		{
            ...
            case Format::Gray8:   cvt_flag = -1;
			case Format::RGB888:  cvt_flag = cv::COLOR_GRAY2RGB;
		    case Format::BGR888:  cvt_flag = cv::COLOR_GRAY2BGR;
		}
	case Format::RGB888:
		switch( format_ )
		{
            case Format::Invalid: cvt_flag = 0;
			case Format::Gray8:  cvt_flag = cv::COLOR_RGB2GRAY;
			case Format::RGB888:  cvt_flag = -1;
		    case Format::BGR888:  cvt_flag = cv::COLOR_RGB2BGR;
		}
    case Format::BGR888:
		switch( format_ )
		{
            case Format::Invalid: cvt_flag = 0;
			case Format::Gray8:  cvt_flag = cv::COLOR_BGR2GRAY;
			case Format::RGB888:  cvt_flag = cv::COLOR_BGR2RGB;
		    case Format::BGR888:  cvt_flag = -1;
		}
    }
...
{
    return img.cols * img.elemSize(); // TODO
}
...
VImage::Format VCVImage_Impl::format() const
{
    ...
    case VImage::Format::Gray8:      expected_channels = 1;
    case VImage::Format::RGB888:     expected_channels = 3;
...
bool VCVImage_Impl::is_valid() const
{
    return !img.empty();
}
