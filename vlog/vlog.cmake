...
FILE( GLOB HEADERS_VLOGGER "${VLIBS_PATH}/vlog/vlog_pretty.h"   )
FILE( GLOB SOURCES_VLOGGER "${VLIBS_PATH}/vlog/vlog_pretty.cpp" )

FILE( GLOB HEADERS_VLOGGER "${VLIBS_PATH}/vlog/vlogger.h"   )
FILE( GLOB SOURCES_VLOGGER "${VLIBS_PATH}/vlog/vlogger.cpp" )

FILE( GLOB HEADERS_VLOGGER "${VLIBS_PATH}/vlog/vlogentry.h"   )
FILE( GLOB SOURCES_VLOGGER "${VLIBS_PATH}/vlog/vlogentry.cpp" )
